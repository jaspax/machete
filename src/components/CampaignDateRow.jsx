    ...
    render() {
        ...
        return (
            <tr>
                ...
                <td><span className="a-size-small metricValue">{common.numberFmt(metrics.impressions, 0)}</span></td>
                <td><span className="a-size-small metricValue">{common.numberFmt(metrics.clicks, 0)}</span></td>
